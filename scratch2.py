...
# Write a function to get the name of the largest NEO

def get_largest_name(neos):
    for name in neos:
        name = name["name"]
    return(name)
...
print("{} is the largest NEO today at a whopping {} meters in diameter! \nThat means it's {} armadillos OR {} Deloreans in diameter!".format(get_largest_name(neos), get_largest_neo(neos), diameter_in_armadillos, diameter_in_deloreans))

#Write a function to return the smallest NEO in diameter
...
# Write a function to get the name of the smallest NEO

def get_smallest_name(neos):
    for name in neos:
        name = name["name"]
    return(name)
# TODO  Write a function to return these calculations

diameter_in_armadillos = round(get_smallest_neo(neos) / length_of_armadillo)
diameter_in_deloreans = round(get_smallest_neo(neos) / length_of_delorean)

print("{} is the smallest NEO today at an itty bitty {} meters in diameter! \nThat means it's {} armadillos OR {} Deloreans in diameter!".format(get_smallest_name(neos), get_smallest_neo(neos), diameter_in_armadillos, diameter_in_deloreans))
